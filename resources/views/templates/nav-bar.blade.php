    ...
    <div class="container">
        <ul class="nav">
            @foreach ($menus as $menu)
                <li class="nav-item">
                    <a class="nav-link active" href="{{route($menu -> url)}}">{{$menu -> title}}</a>
                </li>
            @endforeach
            <li class="nav-item">
                <a class="nav-link active" href="{{route('posts')}}">CARS</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('post-create')}}">ADD POST</a>
            </li>
        </ul>
    </div>
</div> --}}
        ...
        <ul class="navbar-nav mr-auto lg:flex lg:flex-row">
            @foreach ($menus as $menu)
                <li class="nav-item">
                    ...
                    href="{{route($menu -> url)}}" data-mdb-ripple="true" data-mdb-ripple-color="light">{{$menu -> title}}</a>
                </li>
            @endforeach
        </ul>
      </div>
